...
public:
	...
	void Immortality(bool next) { isImmortality = next; }	// •sŽ€‚É‚·‚éŠÖ”
...
private:
	...
	float SPIRAL_MOVE_ATK_MAGNIFICATION;	// ‰QŠªˆÚ“®‚Ì”{—¦
	...
	bool isDrawPolyLine;	// PolyLine‚ð•`‰æ‚·‚é‚©‚Ç‚¤‚©
...
#ifdef _DEBUG	// ƒfƒoƒbƒO•Ï”

	bool isSelectAttack;	// UŒ‚•û–@‚ª‘I‘ð‚³‚ê‚Ä‚¢‚é‚©‚Ç‚¤‚©
	bool isImmortality;		// •sŽ€‚©‚Ç‚¤‚©
